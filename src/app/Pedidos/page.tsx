...
import { getPedidos } from '@/api/database'
  ...
  return (
    <div className="min-h-screen bg-white text-amber-50">
      <Navbar
        ...
        middle={
          <div className="flex gap-6 items-center">
            ...
            <Link href="/Pedidos" className="relative text-white">
              Pedidos
      ...
      <main className="mt-12 bg-white text-black">
        <h1 className="text-3xl font-bold mb-6 text-center tex">Lista de Pedidos</h1>
